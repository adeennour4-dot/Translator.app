...
importers:
  ...
  .:
    dependencies:
      ...
      react-pdf:
        specifier: ^10.1.0
        version: 10.1.0(@types/react@19.1.4)(react-dom@19.1.0(react@19.1.0))(react@19.1.0)
...
packages:
  ...
  '@capacitor/cli@7.4.3':
    resolution: {integrity: sha512-SWozpdDgrbQ/ry1nIapugDFvE9z+l22BmU/+fpgL2Zv5487hGdXvCX5+1SluuFBP3IPpx6b4LjsKnBigyJoUWg==}
    engines: {node: '>=20.0.0'}
    hasBin: true
...
snapshots:
  ...
  react-pdf@10.1.0(@types/react@19.1.4)(react-dom@19.1.0(react@19.1.0))(react@19.1.0):
    dependencies:
      clsx: 2.1.1
      dequal: 2.0.3
      make-cancellable-promise: 2.0.0
